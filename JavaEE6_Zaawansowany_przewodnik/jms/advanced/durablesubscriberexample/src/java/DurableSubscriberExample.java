...
public class DurableSubscriberExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Fabryka po³¹czeñ bez identyfikatora klienta: " + dse.conFacName1);
        System.out.println(
                "Fabryka po³¹czeñ z identyfikatorem klienta: " + dse.conFacName2);
    ...
    public class DurableSubscriber {
        ...
        public void finish() {
            if (connection != null) {
                try {
                    System.out.println(
                            "Usuniêcie przypisania do " + "trwa³ej subskrypcji");
