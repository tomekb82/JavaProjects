package com.packtpub.as7development.chapter10.timer;
...
import com.packtpub.as7development.chapter10.ejb.TheatreBox;
...
public class AutomaticSellerBean
{
	...
	public void automaticCustomer()
	{
  	   ...
  	   if (seatId == -1) {
  		   ...
  		   return ; // Nie ma wiêcej wolnych miejsc.
  	   }
  	       ...
  	       logger.info("Ktoœ w³aœnie zarezerwowa³ miejsce "+(seatId +1)); 
	}
